...
public class Register_And_Edit_Products extends javax.swing.JDialog {
    ...
    @SuppressWarnings("unchecked")
        ...
        cbSize.setFont(new java.awt.Font("Tahoma", 0, 14));         cbSize.setForeground(new java.awt.Color(255, 255, 255));
        ...
        bnt_save.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon_salvarClaro.png")));         bnt_save.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        btn_clear.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon_limparClaro.png")));         btn_clear.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        btn_cancel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon_cancelarClaro.png")));         btn_cancel.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        cbColor.setFont(new java.awt.Font("Tahoma", 0, 14));         cbColor.setForeground(new java.awt.Color(255, 255, 255));
        ...
        cbCategory.setFont(new java.awt.Font("Tahoma", 0, 14));         cbCategory.setForeground(new java.awt.Color(255, 255, 255));
        ...
        btn_addCategory.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon_mais.png")));         btn_addCategory.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        btn_addColor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon_mais.png")));         btn_addColor.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        btn_editCategory.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/edit_19px.png")));         btn_editCategory.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        btn_editColor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/edit_19px.png")));         btn_editColor.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        btn_addBrand.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon_mais.png")));         btn_addBrand.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        btn_editBrand.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/edit_19px.png")));         btn_editBrand.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        cbBrand.setFont(new java.awt.Font("Tahoma", 0, 14));         cbBrand.setForeground(new java.awt.Color(255, 255, 255));
    ...
    private void bnt_saveMouseClicked(java.awt.event.MouseEvent evt) {                bnt_save.requestFocusInWindow();
    ...
    private void btn_clearMouseClicked(java.awt.event.MouseEvent evt) {                Utils.clearFields(pnl_Background);
    }
    private void btn_clearMouseEntered(java.awt.event.MouseEvent evt) {                btn_clear.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon_limpar.png")));
    }
    private void btn_clearMouseExited(java.awt.event.MouseEvent evt) {                btn_clear.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon_limparClaro.png")));
    }
    ...
    private void btn_addColorMouseClicked(java.awt.event.MouseEvent evt) {                new New_Color(this, true).setVisible(true);
    }
    private void btn_addCategoryMouseClicked(java.awt.event.MouseEvent evt) {                new New_Category(this, true).setVisible(true);
    }
    private void btn_addColorMouseEntered(java.awt.event.MouseEvent evt) {        btn_addColor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon_mais_claro.png")));
    }
    private void btn_addColorMouseExited(java.awt.event.MouseEvent evt) {        btn_addColor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon_mais.png")));
    }
    private void btn_addCategoryMouseEntered(java.awt.event.MouseEvent evt) {        btn_addCategory.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon_mais_claro.png")));
    }
    private void btn_addCategoryMouseExited(java.awt.event.MouseEvent evt) {        btn_addCategory.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon_mais.png")));
    }
    private void btn_editColorMouseEntered(java.awt.event.MouseEvent evt) {        btn_editColor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/edit_19px_claro.png")));
    }
    private void btn_editColorMouseExited(java.awt.event.MouseEvent evt) {        btn_editColor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/edit_19px.png")));
    }
    private void btn_editCategoryMouseEntered(java.awt.event.MouseEvent evt) {        btn_editCategory.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/edit_19px_claro.png")));
    }
    private void btn_editCategoryMouseExited(java.awt.event.MouseEvent evt) {        btn_editCategory.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/edit_19px.png")));
    }
    private void btn_editColorMouseClicked(java.awt.event.MouseEvent evt) {        
    ...
    private void btn_editCategoryMouseClicked(java.awt.event.MouseEvent evt) {        if (cbCategory.getSelectedIndex() != 0) {
    ...
    private void btn_addBrandMouseClicked(java.awt.event.MouseEvent evt) {        new New_Brand(this, true).setVisible(true);
    }
    private void btn_addBrandMouseEntered(java.awt.event.MouseEvent evt) {            }
    private void btn_addBrandMouseExited(java.awt.event.MouseEvent evt) {            }
    private void btn_editBrandMouseClicked(java.awt.event.MouseEvent evt) {        if (cbBrand.getSelectedIndex() != 0) {
    ...
    private void btn_editBrandMouseEntered(java.awt.event.MouseEvent evt) {            }
    private void btn_editBrandMouseExited(java.awt.event.MouseEvent evt) {            }
    private void pnl_BackgroundMouseClicked(java.awt.event.MouseEvent evt) {        pnl_Background.requestFocusInWindow();
    }
