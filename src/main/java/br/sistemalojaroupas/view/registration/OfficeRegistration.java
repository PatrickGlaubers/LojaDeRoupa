...
public class OfficeRegistration extends javax.swing.JDialog {
    ...
    @SuppressWarnings("unchecked")
        ...
        txtOffice.setFont(new java.awt.Font("Tahoma", 0, 14));         txtOffice.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jLabel35.setFont(new java.awt.Font("Tahoma", 0, 14));         jLabel35.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jLabel36.setFont(new java.awt.Font("Tahoma", 0, 14));         jLabel36.setForeground(new java.awt.Color(255, 255, 255));
        ...
        title.setFont(new java.awt.Font("Tahoma", 1, 16));         title.setForeground(new java.awt.Color(0, 0, 51));
    ...
    private void chkHomeActionPerformed(java.awt.event.ActionEvent evt) {            }
    ...
    private void bnt_saveMouseClicked(java.awt.event.MouseEvent evt) {        if (txtOffice.getText().equals("")) {
