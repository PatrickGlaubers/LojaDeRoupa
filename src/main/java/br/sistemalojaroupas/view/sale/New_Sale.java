...
public class New_Sale extends javax.swing.JFrame {
    ...
    @SuppressWarnings("unchecked")
        ...
        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14));         jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Nome :");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 100, 60, 30));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 14));         jLabel3.setForeground(new java.awt.Color(0, 176, 240));
        ...
        btn_cancellation.setFont(new java.awt.Font("Tahoma", 1, 14));         btn_cancellation.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14));         jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("CPF :");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 40, 60, 30));

        txt_name.setFont(new java.awt.Font("Tahoma", 0, 14));         txt_name.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txt_name.setBorder(null);
        jPanel1.add(txt_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 100, 280, 30));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 14));         jLabel5.setForeground(new java.awt.Color(0, 176, 240));
        ...
        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 14));         jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("Código :");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 230, 70, 30));

        txt_price.setEditable(false);
        txt_price.setFont(new java.awt.Font("Tahoma", 0, 14));         txt_price.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        btn_searchCPF.setFont(new java.awt.Font("Tahoma", 0, 14));         btn_searchCPF.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 14));         jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        ...
        txt_product.setFont(new java.awt.Font("Tahoma", 0, 14));         txt_product.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 14));         jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        ...
        txt_brand.setFont(new java.awt.Font("Tahoma", 0, 14));         txt_brand.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txt_brand.setBorder(null);
        jPanel1.add(txt_brand, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 360, 280, 30));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 14));         jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        ...
        txt_color.setFont(new java.awt.Font("Tahoma", 0, 14));         txt_color.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txt_color.setBorder(null);
        jPanel1.add(txt_color, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 420, 160, 30));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 14));         jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        ...
        txt_size.setFont(new java.awt.Font("Tahoma", 0, 14));         txt_size.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txt_size.setBorder(null);
        jPanel1.add(txt_size, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 420, 60, 30));

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 14));         jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        ...
        txt_CPF.setFont(new java.awt.Font("Tahoma", 0, 14));         jPanel1.add(txt_CPF, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 40, 120, 30));

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 14));         jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        ...
        txt_Code.setFont(new java.awt.Font("Tahoma", 0, 14));         jPanel1.add(txt_Code, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 230, 110, 30));

        txt_SalesTotal.setEditable(false);
        txt_SalesTotal.setFont(new java.awt.Font("Tahoma", 0, 24));         txt_SalesTotal.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txt_SalesTotal.setText("R$ 0,00");
        ...
        btn_searchCod.setFont(new java.awt.Font("Tahoma", 0, 14));         btn_searchCod.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 18));         jLabel13.setForeground(new java.awt.Color(0, 176, 240));
        ...
        txt_quantity.setText("1");
        txt_quantity.setFont(new java.awt.Font("Tahoma", 0, 14));         txt_quantity.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 14));         jLabel14.setForeground(new java.awt.Color(0, 176, 240));
        ...
        btn_addToCart.setFont(new java.awt.Font("Tahoma", 1, 14));         btn_addToCart.setForeground(new java.awt.Color(255, 255, 255));
        ...
        btn_payment.setFont(new java.awt.Font("Tahoma", 1, 14));         btn_payment.setForeground(new java.awt.Color(255, 255, 255));
        ...
        btnDeleteProduct.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/trash_14px.png")));         btnDeleteProduct.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/background_VENDAS.png")));         jPanel1.add(background, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
    ...
    private void btn_searchCodActionPerformed(java.awt.event.ActionEvent evt) {        product = ProductDao.findById(Utils.tryParseToLong(txt_Code.getText()));
    ...
    private void btn_addToCartActionPerformed(java.awt.event.ActionEvent evt) {        if (nextSale) {
            sale = new Sale();
            nextSale = false;
        }
    ...
    private void btn_paymentActionPerformed(java.awt.event.ActionEvent evt) {        if (sale == null || nextSale) {
    ...
    private void btn_searchCPFActionPerformed(java.awt.event.ActionEvent evt) {        customer = CustomerDao.findByCpf(txt_CPF.getText());
        if (customer == null) {
    ...
    private void btn_cancellationActionPerformed(java.awt.event.ActionEvent evt) {        if (nextSale || !hasProduct) {
            JOptionPane.showMessageDialog(this, "Nenhuma operação da venda foi iniciada.",
                    "Erro", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    private void btnDeleteProductActionPerformed(java.awt.event.ActionEvent evt) {        int selectedRow = table_ShoppingCart.getSelectedRow();
